...
```bash
./models/JinaEmbedding/vLLM/benchmarks/scripts/01_provision_infrastructure.sh
```
...
```bash
./models/JinaEmbedding/vLLM/benchmarks/scripts/02_deploy_tpu_workload.sh
```
...
```bash
./models/JinaEmbedding/vLLM/benchmarks/scripts/03_setup_benchmark_runner.sh
```
...
```bash
./models/JinaEmbedding/vLLM/benchmarks/scripts/04_run_baseline_benchmarks.sh
```
...
```bash
./models/JinaEmbedding/vLLM/benchmarks/scripts/05_run_saturation_benchmarks.sh
```
...
```bash
./models/JinaEmbedding/vLLM/benchmarks/scripts/06_export_results.sh
```
